        ...
        <div class="row pt-2 pb-2">
            ...
            <div class="col-sm-5">
                <div class="btn-group float-sm-right">
                    <button type="submit" class="btn btn-facebook waves-effect waves-light delete-all" record="book-categories"><i class="fa fa-minus mr-1"></i>Xóa
                        Mục Chọn</button>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" style="background-color:#007bff;">
                    ...
                    <form action="{{url('/admin/create/book/category')}}" method="POST">
                        @csrf
                                    ...
                                    <div class="modal fade" id="exampleModal{{$category['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content" style="background-color:#007bff;">
                                                ...
                                                <form action="{{url('/admin/edit/book/category/'.$category['id'])}}" method="POST">
                                                    @csrf
                                                    <div class="modal-body">
