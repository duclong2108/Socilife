                        ...
                        <a href="javaScript:void();">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h6 class="mt-2 user-title">{{$admin['email']}}</h6>
                                </div>
                            </div>
                        </a>
                    </li>
                    <li class="dropdown-divider"></li>
                    <a href="{{url('/admin/account')}}"><li class="dropdown-item"><i class="zmdi zmdi-balance-wallet mr-3"></i>Tài khoản</li></a>
                    <li class="dropdown-divider"></li>
                    <a href="{{url('/admin/logout')}}"><li class="dropdown-item"><i class="zmdi zmdi-power mr-3"></i>Đăng xuất</li></a>
                </ul>
            </li>
        </ul>
    </nav>
